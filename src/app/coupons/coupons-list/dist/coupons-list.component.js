...
exports.CouponsListComponent = void 0;
...
var CouponsListComponent = /** @class */ (function () {
    function CouponsListComponent(api, dialog, snackbar, router) {
        this.api = api;
        this.dialog = dialog;
        this.snackbar = snackbar;
        this.router = router;
        this.dataSource = new table_1.MatTableDataSource([]);
        this.columnsToDisplay = ['name', 'coupon', 'percentage', 'remaining', 'orders', 'sales', 'commission', 'ending', 'status', 'action'];
        this.types = [
            "Affiliate",
            "In Store",
        ];
    ...
    CouponsListComponent.prototype.openExportDialog = function () {
        var _this = this;
    ...
    CouponsListComponent.prototype.generateExcel = function (headers) {
    ...
    CouponsListComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
    };
    CouponsListComponent.prototype["delete"] = function (id) {
        var _this = this;
        ...
        dialog.afterClosed().subscribe(function (data) {
            if (data) {
                _this.api.apiDeleteCall(id, 'coupon/deleteCoupon').subscribe(function (response) {
    ...
    CouponsListComponent.prototype.edit = function (type, id) {
        this.router.navigate(['/coupon/' + type, id]);
    };
    CouponsListComponent.prototype.applyTypeFilter = function () {
        var _this = this;
        var _a, _b;
...
exports.CouponsListComponent = CouponsListComponent;
